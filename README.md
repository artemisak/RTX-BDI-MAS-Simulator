...
The theoretical basis for practical implementation of explainable multi-agent systems (XMAS) technologies into the process of work of the radiology department of a medical and preventive institution has been developed. The system is a mock-up of a digital twin of a radiology department to provide a "second opinion" service.

<h2>Functional purpose</h2>

Exploring opportunities to improve the quality of patient care and reduce average time to care, through the integration of continuing education for young professionals.

<h2>Description of logical structure</h2>
...
Running the simulation requires no special input data and initializes the simulation parameters in the specified way. However, by reading the documentation, you can customize the simulation process to best suit your needs. The demo application for image markup requires a DICOM medical image.

<h2>Output data</h2>

Below are table layouts of the results of running the simulation. In addition to tables, the application logs the process as the simulation progresses and outputs intermediate changes to the terminal.
...
The decision making process is demonstrated as follows.

<div align="center">
  <img src="https://github.com/artemisak/RTX-BDI-MAS-Simulator/blob/main/Supplements/Demonstration .gif"/>
</div>
